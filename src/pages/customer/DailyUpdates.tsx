...
const DailyUpdates: React.FC = () => {
  ...
  const filteredUpdates = mockDailyUpdates.filter(update => {
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <p className="text-gray-400">{selectedUpdate.uploadedBy}</p>
                </div>
                <div>
                  <h4 className="text-white font-medium mb-1">Project</h4>
                  <p className="text-gray-400">{selectedUpdate.project}</p>
                </div>
                <div>
                  <h4 className="text-white font-medium mb-1">Time</h4>
                  <p className="text-gray-400">{formatTime(selectedUpdate.timestamp)}</p>
                </div>
              </div>
            </CardContent>
          </Card>
